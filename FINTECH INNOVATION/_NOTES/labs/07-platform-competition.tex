...
\textbf{Source files.} \texttt{Lab07/platform\_scorecard.py}, \texttt{Lab07/ecosystem\_map.md}.\\
...
\begin{mltable}
\begin{tabularx}{\linewidth}{@{}>{\bfseries\color{MLNavy}}p{0.16\linewidth}X X@{}}
\toprule
