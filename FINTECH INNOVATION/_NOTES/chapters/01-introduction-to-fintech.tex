...
\begin{mltable}
\begin{tabularx}{\linewidth}{@{}>{\bfseries\leavevmode\color{MLNavy}}p{0.23\linewidth}X@{}}
\toprule
\rowcolor{MLPaleBlue!92}
...
\begin{mltable}
\begin{tabularx}{\linewidth}{@{}>{\bfseries\leavevmode\color{MLNavy}}p{0.19\linewidth}X@{}}
\toprule
\rowcolor{MLPaleBlue!92}
...
\input{labs/01-unbundling-teardown}
