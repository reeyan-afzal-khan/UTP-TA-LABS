# FinTech Innovation — LaTeX notes

Self-contained LaTeX source for the FinTech Innovation course notes. This folder has no
...
Produces `fintech-innovation-notes.pdf`. Intermediate files stay in `build/`.
