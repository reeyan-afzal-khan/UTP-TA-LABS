...
\textbf{Source files.} Four C programs in \texttt{Lab08}.\\
...
\begin{debugtask}
The opening comment of \texttt{Task01.c} describes address translation, but the executable code demonstrates a pthread mutex. Document what the code actually does rather than repeating the stale comment.
\end{debugtask}
\end{labproject}
