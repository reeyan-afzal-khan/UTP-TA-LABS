...
\textbf{Source files.} Three C programs in \texttt{source\_code/Lab06}.\\
...
Compare \texttt{task\_1.c} and \texttt{task\_2.c}. Both derive Need from Max. Explain why a strict deadlock-detection algorithm is conceptually different from a Banker's safe-state test.
