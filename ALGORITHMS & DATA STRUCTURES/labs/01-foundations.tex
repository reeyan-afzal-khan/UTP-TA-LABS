...
\textbf{Source files.} \texttt{Lab01/Task01.cpp} --- the student-record application.\\
\textbf{Goal.} Store, display, search, and update at least five student records using a structure, an array, and a pointer.
