...
\textbf{Source files.} \texttt{Lab02/Task04.cpp} (matrix multiplication, transpose, row/column sums). \texttt{Task01--Task03} cover matrix rotation, median, and maximal area.\\
