...
\textbf{Source files.} \texttt{Lab08/Task05.cpp} (binary search), \texttt{Task06.cpp} (descending quick sort, median pivot), \texttt{Task07.cpp} (three-way merge), and \texttt{Task08.cpp} (heap sort). \texttt{Task01--Task04} are bubble, insertion, quick, and selection sort.\\
