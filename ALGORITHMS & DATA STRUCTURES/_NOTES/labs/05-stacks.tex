...
\textbf{Source files.} \texttt{Lab05/Task03.cpp} (array stack), \texttt{Task04.cpp} (linked stack), and \texttt{Task05.cpp} (infix to postfix).\\
\textbf{Goal.} Implement the stack ADT with an array and with a linked list, then apply a stack to infix-to-postfix conversion.
