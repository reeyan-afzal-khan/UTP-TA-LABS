...
UTP-ARTIFICIAL-INTELLIGENCE/
  all_datasets/                  # all csv files dumped into one folder
    lab01-03_airports.csv/
    lab01-03_routes.csv/
    lab04-AirQuality.csv/
    lab05-sensor_readings_4.csv/
    lab07-Tweets.csv/
    lab08-insurance.csv/

  all_experiments/              # one dedicated folder for all labs
    lab01-airport-route-analysis.ipynb/
    lab02-informed-search.ipynb/
    lab03-search-engineering.ipynb/
    lab04-fuzzy-ANFIS.ipynb/
    lab05-robotics.ipynb/
    lab06-NLP-OCR.ipynb/
    lab07-NLP-sentiment.ipynb/
    lab08-genetic-algorithm.ipynb/
