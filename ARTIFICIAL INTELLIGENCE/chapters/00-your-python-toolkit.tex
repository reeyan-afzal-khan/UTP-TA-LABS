...
Use one \textbf{project root} with four folders: \textbf{datasets}, \textbf{experiments} (the notebooks and every helper module they import), the book's \textbf{chapters} and \textbf{lab sheets}, and a \textbf{results} folder that the notebooks fill:
...
Lab~6 additionally needs the Tesseract OCR \emph{engine}, which is not a Python package; its lab sheet gives the one-line installer for each operating system.
