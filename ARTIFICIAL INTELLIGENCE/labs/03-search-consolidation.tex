...
\textbf{Source files.} \texttt{Lab03/search\_toolkit.py} (the module, with a self-test: \texttt{py search\_toolkit.py}) and \texttt{Lab03/run\_all.py} (the driver that prints the comparison table).\\
