...
\textbf{Objective.} Derive a four-sensor threshold policy, compare it with an all-sensor reference model, and test sensitivity to sensor noise.\\
...
\textbf{Notebook.} \texttt{all\_experiments/lab05\_robotics\_sensor\_control\_worked.ipynb}.\\
\end{labproject}
...
Submit the executed notebook and \texttt{results/lab05/}. Identify the rule controller's
hardest action and recommend one response to a 5\,\% sensor-noise budget, including the
