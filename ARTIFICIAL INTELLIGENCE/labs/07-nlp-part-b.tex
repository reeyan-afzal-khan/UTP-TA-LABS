...
Submit the executed notebook and \texttt{results/lab07/}. Explain why macro F1 is the
headline metric, name the weakest class, and propose one stronger text representation
that could be tested without changing the evaluation protocol.
\end{labdeliverable}
