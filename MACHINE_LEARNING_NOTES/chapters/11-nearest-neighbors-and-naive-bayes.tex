...
\begin{enumerate}
  ...
  \item for classification, predict the majority class among the neighbors; for regression, predict the average of their targets.
\end{enumerate}
...
$k$-NN also does regression --- predict the average (or distance-weighted average) target of the neighbors --- which yields a locally adaptive, assumption-free fit, at the price of the same sensitivities listed above.
...
\input{chapters/labs/05-classification-models}
...
\begin{chapterrecap}
\begin{itemize}
  \item $k$-NN predicts from the labels or targets of nearby training observations.
