...
\begin{itemize}
  ...
  \item \term{Variance is not predictive importance}: the directions that vary most are not necessarily the ones that predict a label --- a low-variance component can carry crucial signal. (\chapref{ch:classification}'s LDA is a supervised method that seeks class-separating directions instead.)
