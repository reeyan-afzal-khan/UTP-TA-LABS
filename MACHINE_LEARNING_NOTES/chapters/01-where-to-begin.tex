...
\midrule
Spam filter & A real email is hidden -- irritating, occasionally serious & A spam email arrives -- mildly annoying \\
...
Movie recommendation & A poor suggestion -- ignored & A good movie not shown -- invisible loss \\
\bottomrule
\end{tabularx}
\end{mltable}
...
\begin{tryit}
Pick something a computer decides about you: which movies you are shown, whether a message goes to junk mail, whether a bank approves a payment. Write down the five parts -- observation, feature, target, model, metric -- and then the cost of each direction of error.
\end{tryit}
...
\begin{enumerate}
  ...
  \item Audit and prepare data safely in \chapref{ch:data}.
