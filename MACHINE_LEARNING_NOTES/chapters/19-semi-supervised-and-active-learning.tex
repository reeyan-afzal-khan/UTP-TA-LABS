...
These assumptions may be wrong. Two nearby customers can have different outcomes, or a cluster can contain several classes. Unlabeled data helps only when its structure relates to the target.
...
\begin{mlsteps}
  ...
  \item Inspect whether similarity or cluster structure appears connected to the target.
...
Best when & Human labels are expensive, unlabeled examples are plentiful, and feature-space structure relates to the target. \cr
...
\input{chapters/labs/09-anomaly-limited-labels}
