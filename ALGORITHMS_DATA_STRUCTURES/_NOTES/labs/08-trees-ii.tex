...
\textbf{Source files.} \texttt{Lab06/Task01.cpp} (binary search tree) and \texttt{Task03.cpp} (max-heap and min-heap).\\
\textbf{Goal.} Compare the ordering rules of binary search trees and heaps, and show how each restores its rule after a change.
