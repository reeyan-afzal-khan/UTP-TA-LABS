# Data Science — LaTeX notes

Self-contained LaTeX source for the Data Science course notes. This folder has no
...
Produces `data-science-notes.pdf`. Intermediate files stay in `build/`.
