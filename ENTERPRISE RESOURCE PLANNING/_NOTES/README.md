# Enterprise Resource Planning — LaTeX notes

Self-contained LaTeX source for the Enterprise Resource Planning course notes. This folder has no
...
Produces `enterprise-resource-planning-notes.pdf`. Intermediate files stay in `build/`.
