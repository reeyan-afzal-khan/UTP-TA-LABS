...
\begin{erptable}
\begin{tabularx}{\linewidth}{@{}>{\bfseries\color{ERPNavy}}p{0.24\linewidth}X@{}}
\toprule
...
\begin{erptable}
\begin{tabularx}{\linewidth}{@{}>{\bfseries\color{ERPNavy}}p{0.28\linewidth}XX@{}}
\toprule
\rowcolor{ERPPaleBlue!92}
...
\begin{erptable}
\begin{tabularx}{\linewidth}{@{}>{\bfseries\color{ERPNavy}}p{0.23\linewidth}p{0.27\linewidth}X@{}}
\toprule
\rowcolor{ERPPaleBlue!92}
